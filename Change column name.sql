...
Create table New_SQL_Class.customerstwo (
...
CREATE TABLE New_SQL_Class.orderstwo (
    order_id INT PRIMARY KEY,
    order_date DATE,
    Client_ID INT,
    FOREIGN KEY (Client_ID) REFERENCES New_SQL_Class.customerstwo(Client_ID)
);

Insert into New_SQL_Class.customerstwo (Client_ID,First_Name,Last_Name, Postal_Address, State_Address)
Values (1,'Ammar','Jamshed', 'house 4 56', '45567');

select * from New_SQL_Class.customerstwo;
